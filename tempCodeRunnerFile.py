...
# 1. Daten laden (Stichprobe von 5000 Zeilen entnehmen, um den Prozess zu beschleunigen und Abstürze zu vermeiden)
print("Loading data...")
# Sicherstellen, dass der Dateiname der verwendeten Datei entspricht
...
def clean_text(text):
    ...
    # Stoppwörter entfernen und Wörter lemmatisieren (auf Grundform reduzieren)
    words = text.split()
...
# 3. Vektorisierung (Umwandlung in numerische Vektoren)
print("Vectorizing...")
